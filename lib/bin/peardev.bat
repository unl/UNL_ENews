...
FOR %%x IN ("/Users/bbieber/Documents/workspace/UNL_ENews/lib/php") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=/Users/bbieber/Documents/workspace/UNL_ENews/lib/php"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=/Users/bbieber/workspace/UNL_ENews/lib/bin"

    ...
    <tbody>
        ...
        <tr>
            ...
            <td align="center">
                ...
                <?php else: ?>
                <a class="action send" href="<?php echo UNL_ENews_Controller::getURL(); ?>?view=sendnews&amp;id=<?php echo $newsletter->id; ?>" onclick="return confirm('This newsletter is scheduled for distribution on <?php echo date('M jS', $newsletterDate); ?>.\n\nAre you sure you want to send it now?')">Distribute Now</a>
                <?php endif; ?>
            </td>
            <td align="center">
                <?php if ($newsletter->distributed): ?>

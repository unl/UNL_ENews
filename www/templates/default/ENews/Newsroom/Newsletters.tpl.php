...
<table class="functionTable">
    ...
    <tbody>
        ...
        ?>
        <tr>
            <td class="mainCell" style="min-width:600px;"><h5><?php echo $newsletter->subject; ?></h5>
            ...
            <td align="center">
                ...
                <?php else: ?>
                <a class="action send" href="?view=sendnews&amp;id=<?php echo $newsletter->id; ?>" onclick="return confirm('Are you sure?')">Send</a>
                <?php endif; ?>
            </td>
            <td align="center">
                <?php if ($newsletter->distributed): ?>

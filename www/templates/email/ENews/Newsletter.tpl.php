...
<tr>
    <td align="center" valign="top">
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="600">
            <tr>
                <td valign="top" style="font-size: 0px;"><img src="http://www.unl.edu/wdn/templates_3.0/images/email/header.png" alt="The University of Nebraska-Lincoln" width="600" height="126" border="0"/></td>
            </tr>
        </table>
        <!-- [ middle starts here] -->
        <table cellspacing="0" cellpadding="0" border="0" width="600" style="margin:0;font-size:0">
            <tr>
                <td width="12" bgcolor="#E0E0E0" style="margin:0;font-size:0">&nbsp;</td>
                <td width="10" style="margin:0;font-size:0">&nbsp;</td>
                <td align="left" valign="top" width="556" style="margin:0;font-size:0">
                    <table cellspacing="0" cellpadding="0" border="0" style="margin:0;font-size:0">
                        <tr>
        ...
        <table cellspacing="0" cellpadding="0" border="0" width="600" style="margin:0;font-size:0">
            <tr>
                <td style="font-size: 0px;margin:0;"><img src="http://www.unl.edu/wdn/templates_3.0/images/email/footer.png" alt="The University of Nebraska-Lincoln" width="600" height="22" /></td>
            </tr>
        </table>
    </td>
</tr>

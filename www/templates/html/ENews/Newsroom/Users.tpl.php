...
<?php foreach ($context as $user): ?>
    <li class="dcf-p-1 dcf-relative">
      <img class="dcf-d-block" src="https://directory.unl.edu/avatar/<?php echo $user->uid ?>?s=medium" alt="Profile photo of <?php echo $user->uid ?>" />
      <form class="dcf-absolute dcf-d-none" action="<?php echo UNL_ENews_Controller::getURL() ?>?view=newsroom" method="post">

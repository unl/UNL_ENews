...
<script type="text/javascript">
  document.addEventListener('DOMContentLoaded', function () { WDN.jQuery("#story_<?php echo $context->story_id; ?>").data(<?php echo json_encode(array(
      'id' => $context->story_id,
...
<script type="text/javascript">
  document.addEventListener('DOMContentLoaded', function () { WDN.jQuery("#story_<?php echo $context->id; ?>").data(<?php echo json_encode(array(
    'id' => $context->id,
    'title' => $context->title,

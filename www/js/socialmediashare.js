define(['jquery', 'wdn', 'require', 'wdn-ui'], function($, WDN, require, wdnUI) {
  ...
  var Plugin = {
    ...
    shareButtonTemplate: '<button class="wdn-dropdown-widget-button" aria-pressed="false" aria-haspopup="true" aria-controls="wdn_share_{{id}}"><span class="wdn-icon-share" aria-hidden="true"></span><span class="dcf-sr-only">Share This Page</span></button>'+ // add string to use as template for all share buttons
